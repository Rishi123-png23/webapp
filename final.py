...
if selected == "Transport":
           st.header("TRANSPORTATION FOR VJIT ")
           selected = option_menu(
           menu_title ="",
           options =["College bus","Own transport"],
           icons = ["pin-map","pin-map"],
           menu_icon = "cast",
           default_index = 0)
                      
           if selected == "College bus": 
                ...
                st.subheader("Route No.8 Nagole- Ramanthapur :")
                st.write("""
                ...
                st.subheader("Route No.9 Lb Nagar :")
                st.write("""
                ...
                st.subheader("Route No.10 Vansthalipuram:")
                st.write("""
                ...
                st.subheader("Route No.13 Attpur :")
                st.write("""
                ...
                st.subheader("Route No.21 Patancheru :")
                st.write("""
           ...
           if selected == "Own transport":
                st.header("Own Transportation for VJIT")
                st.subheader("Public Transport")
                st.write("""
                             - From Mehdipatnam take any bus which goes towards Chilkur Balaji temple.
                             - RTC bus series of 288, 444 & 446 pass through the Aziz Nagar gate with the frequency of 5 – 10 minutes.
                             - VJIT is located just opposite Aziznagar Gate.""")
                st.subheader("Own Vehicle")
                st.image(img_bike_vjit,use_column_width = 700,width = 900 )
                st.write("""
                       - From Mehdipatnam come towards Langer house taking a left at Nanal Nagar (landmark symbol of hand in the traffic circle).
                       - After crossing Langer house take towards APPA (Andhra Pradesh Police Academy) Junction.
                       - At APPA Junction take the route towards Chilkur Balaji Temple/ Vikarabad/ Moinabad.
                       - The college is just 5 km. from APPA Junction and is opposite to Aziznagar Gate.""")
                st.subheader("Google Map for VJIT")
                vjit_map = """ <p><iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3808.376934232647!2d78.3235988!3d17.3455861!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bcb95a278ecef95%3A0x6cd763949617029a!2sVidya%20Jyothi%20Institute%20of%20Technology!5e0!3m2!1sen!2sin!4v1660741544318!5m2!1sen!2sin" width="800" height="600" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe></p> """
                st.markdown(vjit_map,unsafe_allow_html = True)
...
if selected == "Developer":
     ...
     st.write("------------")
     st.header(" They done a preponderance role in this project")
     ...
     st.write(" - Jashwanth(20911A6740 , CSE-DS) [***  Information Gathering ,Idea's ***]")
